...
const static std::unordered_map<Kind, std::pair<internal::Kind, std::string>>
    s_kinds{
        ...
        KIND_ENUM(Kind::EXISTS_EXACTLY, internal::Kind::EXISTS_EXACTLY),
        KIND_ENUM(Kind::QE_SEGMENT, internal::Kind::QE_SEGMENT),
...
const static std::unordered_map<internal::Kind,
    ...
    s_kinds_internal{
        ...
        {internal::Kind::EXISTS_EXACTLY, Kind::EXISTS_EXACTLY},
        {internal::Kind::QE_SEGMENT, Kind::QE_SEGMENT},
